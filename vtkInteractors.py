...
###############    Method 1 ################
# Re-implement vtkInteractorStyle
class QIN_Style(vtk.vtkInteractorStyle):
    def __init__(self):
...
'''
vtkCommand contains many kinds of EndEvent (to name but a few)
1. LeftButtonPressEvent
2. RightButtonPressEvent
3. vtk.vtkCommand.MiddleButtonPressEvent
4. vtk.vtkCommand.KeyPressEvent
5. vtk.vtkCommand.KeyReleaseEvent
...
'''